  ...
  public: {
    Tables: {
      ...
      accidents_travail: {
        ...
        Relationships: [
          {
            foreignKeyName: "accidents_travail_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      bulletins_paie: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "bulletins_paie_periode_id_fkey"
            columns: ["periode_id"]
            isOneToOne: false
            referencedRelation: "periodes_paie"
            referencedColumns: ["id"]
          },
        ]
      }
      bulletins_paie_lignes: {
        Row: {
          base: number | null
          bulletin_id: string
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "bulletins_paie_lignes_bulletin_id_fkey"
            columns: ["bulletin_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bulletins_paie_lignes_rubrique_id_fkey"
            columns: ["rubrique_id"]
            isOneToOne: false
            referencedRelation: "rubriques_paie"
            referencedColumns: ["id"]
          },
        ]
      }
      carrieres: {
        ...
        Relationships: [
          {
            foreignKeyName: "carrieres_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      cnss_declarations: {
        Row: {
          ...
          cotisation_salariale: number | null
          created_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "cnss_declarations_periode_id_fkey"
            columns: ["periode_id"]
            isOneToOne: false
            referencedRelation: "periodes_paie"
            referencedColumns: ["id"]
      ...
      elements_salaire: {
        ...
        Relationships: [
          {
            foreignKeyName: "elements_salaire_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      evaluations: {
        Row: {
          ...
          objectifs_prochaine_periode: string | null
      ...
      heures_supplementaires: {
        ...
        Relationships: [
          {
            foreignKeyName: "heures_supplementaires_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      inspections_travail: {
        Row: {
          ...
          date_limite_correction: string | null
          id: string
      ...
      notes_frais: {
        ...
        Relationships: [
          {
            foreignKeyName: "notes_frais_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      prets: {
        ...
        Relationships: [
          {
            foreignKeyName: "prets_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      reclamations: {
        ...
        Relationships: [
          {
            foreignKeyName: "reclamations_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      sanctions: {
        ...
        Relationships: [
          {
            foreignKeyName: "sanctions_employe_id_fkey"
            columns: ["employe_id"]
            isOneToOne: false
            referencedRelation: "employes"
            referencedColumns: ["id"]
      ...
      socotac_controles: {
        ...
        Relationships: [
          {
            foreignKeyName: "socotac_controles_equipement_id_fkey"
            columns: ["equipement_id"]
            isOneToOne: false
            referencedRelation: "gmao_equipements"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "socotac_controles_equipement_remorque_id_fkey"
            columns: ["equipement_remorque_id"]
            isOneToOne: false
            referencedRelation: "gmao_equipements"
            referencedColumns: ["id"]
