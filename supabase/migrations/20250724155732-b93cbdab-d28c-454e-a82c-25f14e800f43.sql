-- Vider les tables existantes dans le bon ordre

-- D'abord vider la table bons_livraison qui référence missions
...
-- Tables de documents (corriger - pas de table documents_chauffeurs)
